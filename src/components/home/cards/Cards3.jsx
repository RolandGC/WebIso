            ...
            <div>
                <div className="mx-auto grid max-w-7xl px-3 lg:grid-cols-4 m-3 sm:grid-cols-2">
                    <div className="flex justify-center items-center gap-x-3 border-r border-gray-400">
                        <div className='m-4 p-2 font-bebas tracking-wide'>
                            ...
                            <p className="text-sm font-extralight font-bebas tracking-wide leading-6 text-gray-700 mt-3 flex justify-center"> propiedades</p>
                        </div>
                    </div>
                    <div className="flex justify-center items-center gap-x-3 border-r border-gray-400">
                        <div className='m-4 p-2 font-bebas tracking-wide'>
